...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <spring:url value="/resources/vendor/bootstrap/css/bootstrap.min.css" var="coreCss" />

    <!-- MetisMenu CSS -->
    <spring:url value="/resources/vendor/metisMenu/metisMenu.min.css" var="coreCss" />

    <!-- CSS custom to app -->
    <spring:url value="/resources/dist/css/custom.css" var="coreCss" />

    <!-- Morris Charts CSS -->
    <spring:url value="/resources/vendor/morrisjs/morris.css" var="coreCss" />
...
<body>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                            <a href="#">
                                <div>
                                    <i class="fa fa-comment fa-fw"></i> Novos Comentarios
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="cotacao-auto.html"><i class="fa fa-car fa-fw"></i> Cotação Automóvel</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Cotação RE<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="index-original.html">Grandes Riscos</a>
                                </li>
                                <li>
    ...
    <!-- JavaScript customizado para a aplicação -->
